...
if __name__ == "__main__":
    ...
    """ Directories """
    create_dir("/content/drive/MyDrive/afanet_files1")

    """ Training logfile """
    train_log_path = '/content/drive/MyDrive/afanet_files1/train_log.txt'
    if os.path.exists(train_log_path):
        print("Log file exists")
    else:
        train_log = open('/content/drive/MyDrive/afanet_files1/train_log.txt', "w")
        train_log.write("\n")
        train_log.close()
    ...
    checkpoint_path = "/content/drive/MyDrive/afanet_files1/checkpoint.pth"
